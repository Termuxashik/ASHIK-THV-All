...
logo=("""
\033[1;37;1m  _______ _ __    __   __   __
\033[1;37;1m ||__ __||  | |   | |  \ \ / /
\033[1;37;1m  \ | | /   | ||__| |  \ \ / /
\033[1;37;1m    | |     | |__ | |  \ \ / / 
\033[1;37;1m    | |     | |   | |    \ / 
...
\033[1;37;1m-----------------------------------------------
\033[1;37;1m ▶ Author   : ASHIK THV
\033[1;37;1m ▶ Facebook : Md. Srabon Ahmed 
  ...
  #  print("To stop process press CTRL c")
    ...
    def rana(user):
        ...
        #        print('\r{}\033[1;94m[2F-KING] {} {} {} {}'.format(G, url, fax, px, mys))
                ...
                #print(response.text)
                continue
        sys.stdout.write('\r {} [ASHIK] [{}|{}] [OK:{}] {}\r'.format(mys, str(loop), str(len(idx)), str(len(oku)) ,mys))
        sys.stdout.flush()
        loop += 1       
...
def menu(): 
			...
			if xd in ['1','01']:
				...
				os.system(f'xdg-open https://www.facebook.com/The.Hidden.Virus.05');menu()
			elif xd in ['0','00']:
